...
// handleCustomer — не-админ: deep-link промокоды, ответы-отзывы и кнопка Mini App.
...
func (b *Bot) handleCallback(cb *tgbotapi.CallbackQuery) {
	...
	case "ophoto": // фото букета → сохранить на заказе и отправить клиенту
		...
		b.wizards[chatID] = &wizard{mode: "order_photo", orderID: id, msgID: cb.Message.MessageID}
		kind := "сборки"

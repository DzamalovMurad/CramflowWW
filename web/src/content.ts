...
export const content = {
  ...
  cart: {
    ...
    toCatalog: 'в каталог',
    seeHits: 'посмотреть хиты',
    hitsTitle: 'хиты недели',
    inBouquet: 'в букете',
    total: 'итого',
  ...
  /** Экран, который показывает ErrorBoundary вместо белой страницы. */
  crash: {
    title: 'что-то пошло не так',
    hint: 'приложение не смогло открыться. заказ можно оформить прямо в чате с ботом — командой /order',
  ...
  profile: {
    ...
    discount: 'скидка',
    toCatalog: 'в каталог',
    subPromoTitle: 'промокод за подписку',
    subPromoText: 'подпишитесь на наш канал — подарим промокод на скидку 5% на следующий заказ',
    subPromoChannel: 'открыть канал',
    subPromoClaim: 'я подписан(а) — получить промокод',
    subPromoChecking: 'проверяем…',
    subPromoYours: 'ваш промокод за подписку',
    about: 'о проекте',

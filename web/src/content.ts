 ...
 */
/** Канал магазина: единственная внешняя ссылка приложения. */
export const CHANNEL_URL = 'https://t.me/Flowix_offical';
...
export const content = {
  ...
  home: {
    ...
    /**
     * Плашка перехода в канал. Тон референса: короткая уверенная фраза,
     * которая работает сама по себе. Ни слова «подпишитесь» — причина зайти
     * должна быть в самой фразе, а не в просьбе.
     */
    channelMeta: '✈️ telegram · поставки по утрам',
    /** Заголовок разбит на строки: они разного цвета, как в постерной вёрстке. */
    channelTitleTop: 'первым видишь —',
    channelTitleBottom: 'первым забираешь',
    channelNote: '🌿 свежее уходит до обеда',
